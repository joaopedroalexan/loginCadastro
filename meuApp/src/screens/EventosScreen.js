...
export default function EventosScreen() {
  ...
  const [eventoSelecionado, setEventoSelecionado] = useState(" r");
  ...
  async function abrirModalComIngresso(eventos) {
    setEventoSelecionado(eventos);
    setModalVisible(true);
    try {
      const response = await api.getIngressosPorEvento(eventos.id_evento);
